...
package edu.colorado.phet.balanceandtorquestudy.common;

/**
 * @author John Blanco
 */
public class BalanceAndTorqueSharedConstants {
    public static final double FRAME_RATE = 30.0;

    // The following constant controls whether meters are shown as their
