...
public abstract class ToolBoxItem extends PComposite {
    ...
    protected static final ModelViewTransform SCALING_MVT = ModelViewTransform.createSinglePointScaleInvertedYMapping( new Point2D.Double( 0, 0 ), new Point2D.Double( 0, 0 ), 10 );
    ...
    public ToolBoxItem( final MembraneChannelsModel model, final ModelViewTransform mvt, final PhetPCanvas canvas ) {
