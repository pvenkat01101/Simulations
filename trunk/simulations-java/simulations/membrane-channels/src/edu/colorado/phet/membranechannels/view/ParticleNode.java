...
public class ParticleNode extends PNode {
    ...
    public ParticleNode( Particle particle, ModelViewTransform modelViewTransform ) {
    ...
    private PNode createRepresentation() {
        ...
        switch( particle.getType() ) {
            case SODIUM_ION:
                SphericalNode sphereRepresentation = new SphericalNode( modelViewTransform.modelToViewDeltaX( particle.getDiameter() ),
            ...
            case POTASSIUM_ION:
                size = modelViewTransform.modelToViewDeltaX( particle.getDiameter() ) * 0.85;
            ...
            case PROTEIN_ION:
                size = modelViewTransform.modelToViewDeltaX( particle.getDiameter() );
            ...
            default:
                ...
                representation = new SphericalNode( modelViewTransform.modelToViewDeltaX( particle.getDiameter() ),
