...
public class FluorescentLightBulb extends LightBulb {
    ...
    public static final ModelElementImage BACK_OFF = new ModelElementImage( FLUORESCENT_BACK_2, IMAGE_OFFSET );
    public static final ModelElementImage BACK_ON = new ModelElementImage( FLUORESCENT_ON_BACK_2, IMAGE_OFFSET );

    public static final ModelElementImage FRONT_OFF = new ModelElementImage( FLUORESCENT_FRONT_2, IMAGE_OFFSET );
    public static final ModelElementImage FRONT_ON = new ModelElementImage( FLUORESCENT_ON_FRONT_2, IMAGE_OFFSET );
