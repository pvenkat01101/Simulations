...
public class GraphicSlider extends GraphicLayerSet {
    ...
    */
    ...
    private class KnobListener extends MouseInputAdapter {
        ...
        private Point2D _knobStartPoint;
        ...
        public KnobListener() {
            ...
            _dragStartPoint = new Point2D.Double();
            _knobStartPoint = new Point2D.Double();
        }
        ...
        public void mousePressed( MouseEvent e ) {
            ...
            try {
                ...
                transform.inverseTransform( knobLocation, _knobStartPoint );
                transform.inverseTransform( e.getPoint(), _dragStartPoint );
            }
        ...
        public void mouseDragged( MouseEvent event ) {
            ...
            double value = ( percent * ( _maximum - _minimum ) ) + _minimum;
