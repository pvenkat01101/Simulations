...
public class GravityUnitControl<T extends FluidPressureAndFlowModel> extends MinimizableControl {
    public GravityUnitControl( final FluidPressureAndFlowModule<T> module, Unit gravityUnits ) {
        super( UserComponents.minimizeGravityControlButton, UserComponents.maximizeGravityControlButton, module.gravityControlVisible, new GravitySlider<T>( module, gravityUnits, module.gravityControlVisible ), Strings.GRAVITY );
    }
}
