...
public class BarMagnetPanel extends FaradayPanel {
    ...
    public BarMagnetPanel(
        ...
        _flipPolarityButton = new SimSharingJButton( qualifyUserComponent( Components.flipPolarityButton ), FaradayStrings.BUTTON_FLIP_POLARITY );

        // Magnet transparency on/off
        _seeInsideCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.seeInsideMagnetCheckBox ), FaradayStrings.CHECK_BOX_SEE_INSIDE );
        ...
        // Earth on/off
        _earthCheckBox = new SimSharingJCheckBox( UserComponentChain.chain( Components.showEarthCheckBox ), FaradayStrings.CHECK_BOX_SHOW_EARTH );
