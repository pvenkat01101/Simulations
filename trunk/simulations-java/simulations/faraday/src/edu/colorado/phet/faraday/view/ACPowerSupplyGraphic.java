...
public class ACPowerSupplyGraphic extends GraphicLayerSet implements SimpleObserver {
    ...
    public ACPowerSupplyGraphic( Component component, ACPowerSupply acPowerSupplyModel ) {
        ...
        {
            _maxAmplitudeSlider = new FaradaySlider( qualifiedUserComponent( Components.maxAmplitudeSlider ), component, 100 /* track length */ );
        ...
        // Frequency slider
        {
            _frequencySlider = new FaradaySlider( qualifiedUserComponent( Components.frequencySlider ), component, 100 /* track length */ );
...
//        }
    ...
    private IUserComponent qualifiedUserComponent( IUserComponent userComponent ) {
        return UserComponentChain.chain( Components.acPowerSupply, userComponent );
    }
