    ...
    */
    ...
    private class KnobListener extends MouseInputAdapter {
        ...
        @Override public void mousePressed( MouseEvent e ) {
            SimSharingManager.sendUserMessage( _userComponent, UserComponentTypes.slider, UserActions.startDrag, ParameterSet.parameterSet( ParameterKeys.value, getValue() ) );
        }

        @Override public void mouseReleased( MouseEvent e ) {
            SimSharingManager.sendUserMessage( _userComponent, UserComponentTypes.slider, UserActions.endDrag, ParameterSet.parameterSet( ParameterKeys.value, getValue() ) );
        }
