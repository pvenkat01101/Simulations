...
object SimUseGraphSupport {
  ...
  lazy val groups = {
    ...
    //    Group("a1", load(files.filter(_.getName.indexOf("s152_w1p_a1_c1_2012-01-25_13-16-14_4pkk224opf68l94ngdlooepjfh_c5f2q8mvkmq2sojqtp0ftlh6um") >= 0)) map toReport) ::
    //    Group("a2", load(files.filter(_.getName.indexOf("s120_t8a_a2_c10") >= 0)) map toReport) ::
    //    Group("a3", load(files.filter(_.getName.indexOf("s130_t1p_a3_c3") >= 0)) map toReport) :: Nil
