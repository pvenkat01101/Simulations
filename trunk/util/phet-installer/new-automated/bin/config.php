<?php
    ...
    define("RIPPER_USER_AGENT_PHET_ACTIVITIES",  '"httrack-web-offline-activities-en"');
    ...
    define("RIPPER_ARGS_PHET_WITH_ACTIVITIES", '"'.PHET_ROOT_URL.'" "'.PHET_SPONSOR_LIST_URL.'" -O "'.RIPPED_WEBSITE_ROOT.'" '.PHET_RIPPER_FILTER_PHET_WITH_ACTIVITIES." -F ".RIPPER_USER_AGENT_PHET_ACTIVITIES.RIPPER_OPTIONS);
    ...
    define("INSTALLER_BACKUP_ROOT_DIR", "/data/share/phet/installer-backups/");
