...
class Internationalizer{
	...
	function initialize(){
		...
		this.setString(_root.label_txt, "resistanceEq", "right");
		this.setString(_root.label2_txt, "cm", "right");
		this.setString(_root.label3_txt, "cm", "right");
		this.setString(_root.label4_txt, "cm", "right");
		//_root.ohm_str = this.simStrings.get("ohm");
