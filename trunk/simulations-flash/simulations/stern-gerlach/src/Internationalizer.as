...
class Internationalizer{
	...
	function initialize(){
		...
		this.setString(_level0.controlPanel_mc.label_txt, "sternGerlachExperiment", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.myRadioGroup.label_txt, "numberOfMagnets", "right");
		this.setString(_level0.controlPanel_mc.magnetPanel.resetAllButton_mc.label_txt, "reset", "center");
		this.setString(_level0.controlPanel_mc.magnetPanel.dial1.label_txt, "angle", "center");
		this.setString(_level0.controlPanel_mc.magnetPanel.dial2.label_txt, "angle2", "center");
		this.setString(_level0.controlPanel_mc.magnetPanel.dial3.label_txt, "angle3", "center");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch1.label1_txt, "up", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch1.label2_txt, "down", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch2.label1_txt, "up", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch2.label2_txt, "down", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch3.label1_txt, "up", "left");
		this.setString(_level0.controlPanel_mc.magnetPanel.switch3.label2_txt, "down", "left");
		
		this.setString(_level0.controlPanel_mc.gunPanel.fireButton_mc.label_txt, "fireAtom", "center");
		this.setString(_level0.controlPanel_mc.gunPanel.autoFireButton_mc.label_txt, "autoFire", "center");
		this.setString(_level0.controlPanel_mc.gunPanel.resetButton_mc.label_txt, "resetCount", "center");
		this.setString(_level0.controlPanel_mc.gunPanel.onOffContainer_mc.onOffSign_mc.label1_txt, "on", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.onOffContainer_mc.onOffSign_mc.label2_txt, "off", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.slider_mc.label1_txt,"slow", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.slider_mc.label2_txt,"fast", "right");
		
		this.setString(_level0.controlPanel_mc.gunPanel.spinRadioGroup_mc.label1_txt,"spinOrientation", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.spinRadioGroup_mc.label2_txt,"+z", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.spinRadioGroup_mc.label3_txt,"+x", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.spinRadioGroup_mc.label4_txt,"-z", "left");
		this.setString(_level0.controlPanel_mc.gunPanel.spinRadioGroup_mc.label5_txt,"randomXZ", "left");
		
		this.setString(_level0.controlPanel_mc.sound_ch.label_txt, "sound", "left");
