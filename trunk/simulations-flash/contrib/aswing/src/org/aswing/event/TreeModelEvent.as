 ...
 * @author iiley
 */
class org.aswing.event.TreeModelEvent extends Event {
	
    /** Path to the parent of the nodes that have changed. */
    private var path:TreePath;
    /** Indices identifying the position of where the children were. */
    private var childIndices:Array;
     ...
     *                 changed objects
     */
    public function TreeModelEvent(source:Object, path, childIndices:Array,
			  children:Array)
    {
		super(source);
     ...
     */
    public function getChildIndices():Array {
		if(childIndices != null) {
		    return childIndices.concat();
		}
		return null;
    }
