...
/**
 * Small icon-like button used to display or hide graphics. Button looks like small red minus sign (press to hide)
 * or small green plus sign (press to show)
 */
public class ShowHideButton extends Sprite {
    private var showButton: Sprite;       //green plus icon
    private var hideButton: Sprite;       //red minus icon
    private var container: Object;        //container of the graphics which this button shows/hides
