...
//        neutron.scale( 24 / neutron.getFullBounds().getWidth() );
//        Image i = neutron.toImage();
//        ImageIO.write( BufferedImageUtils.toBufferedImage( i ), "PNG", new File( "C:\\Users\\Owner\\Desktop\\neutron.png" ) );
    }
}
