...
public class OpticsLabCanvas extends Canvas {

    var buttonHolder: Sprite = new Sprite();
    private var RENDER_WIDTH: int = 1024;
    private var RENDER_HEIGHT: int = 768;

    public function OpticsLabCanvas() {
    }//end constructor

    public function init(): void {
        setStyle( "backgroundColor", Util.BACKGROUNDCOLOR );    //Util.XYAXESCOLOR beige is 0xf1f191
        percentWidth = 100;
        percentHeight = 100;
