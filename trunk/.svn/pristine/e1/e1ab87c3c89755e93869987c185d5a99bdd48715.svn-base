 ...
 * @author iiley
 */
class org.aswing.tree.DefaultTreeModel implements TreeModel {
    /** Root of the tree. */
    ...
    /**
      ...
      */
    public function DefaultTreeModel(root:TreeNode, asc:Boolean) {
    ...
    public function insertNodeInto(newChild:MutableTreeNode,
                               parent:MutableTreeNode, index:Number):Void{
