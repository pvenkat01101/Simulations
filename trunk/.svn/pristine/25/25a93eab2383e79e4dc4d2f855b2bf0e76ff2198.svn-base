<?php
    ...
    function deploy_back_up_current_installers(){
        ...
        back_up_file( DEPLOY_DIR.WINDOWS_INSTALLER_WITH_ACTIVITIES_FILE_NAME, $backup_dir_name.WINDOWS_INSTALLER_WITH_ACTIVITIES_FILE_NAME );
        back_up_file( DEPLOY_DIR.OSX_INSTALLER_WITH_ACTIVITIES_FILE_NAME, $backup_dir_name.OSX_INSTALLER_WITH_ACTIVITIES_FILE_NAME );
        back_up_file( DEPLOY_DIR.LINUX_INSTALLER_WITH_ACTIVITIES_FILE_NAME, $backup_dir_name.LINUX_INSTALLER_WITH_ACTIVITIES_FILE_NAME );
