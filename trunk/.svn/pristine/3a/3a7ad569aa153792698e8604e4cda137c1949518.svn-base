...
//    private var dt: Number;             //time step for trajectory algorithm, all times in seconds
    ...
    private var trajectories_arr:Array;       //array of trajectories
    private var currentTrajectoryIndex: int; //index of most recent trajectory started: trajectories_arr[currentTrajectoryIndex] = current trajectory .
    ...
    public function MainModel( mainView: MainView ) {
        ...
        this.trajectories_arr = new Array();
...
//        this.updateViews();
    ...
    public function fireCannon():void{
        this.trajectories_arr[ currentTrajectoryIndex ] = new Trajectory( this );
        this.trajectories_arr[ currentTrajectoryIndex ].startTrajectory();
//        _xP = xP0;
//        _yP = yP0;
//        xP00 = xP0;
//        yP00 = yP0;
...
//    }//stepForward()
    ...
    public function pauseSim():void{
        this._paused = true;
        for(var i:int; i < currentTrajectoryIndex; i++) {
            this.trajectories_arr[i].pause();
        }
    }
    ...
    public function unPauseSim():void{
        this._paused = false;
        for(var i:int; i < currentTrajectoryIndex; i++) {
            this.trajectories_arr[i].unPause();
        }
    }
