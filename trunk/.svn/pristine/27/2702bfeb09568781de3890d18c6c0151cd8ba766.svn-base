...
public class LactoseInjectorNode extends PNode {
    ...
    private final MutableVector2D nominalInjectionVelocityVector = new MutableVector2D( NOMINAL_LACTOSE_INJECTION_VELOCITY, 0 );
    ...
    public LactoseInjectorNode( final IGeneNetworkModelControl model, ModelViewTransform2D mvt, double rotationAngle,
        ...
        if ( labelText != null ) {
            ...
            PText label = new PText( labelText );
    ...
    private void injectLactose() {
        MutableVector2D initialVelocity = new MutableVector2D( nominalInjectionVelocityVector );
