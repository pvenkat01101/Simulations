 ...
 * @author John Blanco
 */
public class ConfigurableHeatCapacityBlockNode extends PComposite {
    ...
    public ConfigurableHeatCapacityBlockNode( final EFACIntroModel model, final ConfigurableHeatCapacityBlock block, final ModelViewTransform mvt ) {
        ...
        final PNode blockFace = createSurface( blockFaceShape, block.color, block.getFrontTextureImage() );
        final PNode blockTop = createSurface( blockTopShape, block.color, block.getTopTextureImage() );
        final PNode blockSide = createSurface( blockSideShape, block.color, block.getSideTextureImage() );
        addChild( blockFace );
        addChild( blockTop );
        addChild( blockSide );
    ...
    */
    ...
    private PNode createSurface( Shape shape, Property<Color> fillColor, Image textureImage ) {
