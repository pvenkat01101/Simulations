...
public abstract class AtomicNucleus implements NuclearDecayControl {
    ...
    public void setAcceleration( MutableVector2D accelerationVector ) {
        _xAcceleration = accelerationVector.getX();
        _yAcceleration = accelerationVector.getY();
    }

    public MutableVector2D getAcceleration() {
        return new MutableVector2D( _xAcceleration, _yAcceleration );
    }

    public MutableVector2D getVelocity() {
        return new MutableVector2D( _xVelocity, _yVelocity );
    }
