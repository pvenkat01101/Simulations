 ...
 * @author Sam Reid
 */
public @EqualsAndHashCode(callSuper = false) class SetHorizontalBarSet extends F<IntroState, IntroState> {
    private final PieSet pieSet;

    public SetHorizontalBarSet( final PieSet pieSet ) {this.pieSet = pieSet;}
