...
import static edu.colorado.phet.common.phetcommon.util.FunctionalUtils.firstOrNull;
import static edu.colorado.phet.common.phetcommon.util.FunctionalUtils.map;
import static edu.colorado.phet.common.phetcommon.util.FunctionalUtils.subtract;
