...
/**
 * List of levels for when the user is using number cards to create fractions on the "Build a Fraction" tab.
...
public class NumberLevelList implements NumberLevelFactory {
    ...
    public static final PatternMaker verticallySlicedCube = new PatternMaker( "grid", 3 ) {
        @Override public Pattern f( final MixedFraction mixedFraction ) {
    ...
    @SuppressWarnings("unchecked") private NumberLevel level7() {
        List<List<Fraction>> fractionSets = list( list( fraction( 1, 2 ), //unchecked warning
                                                        fraction( 2, 4 ),
                                                        fraction( 3, 6 ) ),
                                                  list( fraction( 1, 3 ),
                                                        fraction( 2, 6 ),
    ...
    @SuppressWarnings("unchecked") private NumberLevel level8() {
        List<List<Fraction>> sets = list( list( fraction( 2, 3 ),//unchecked warning
                                                fraction( 3, 2 ),
                                                fraction( 2, 2 ),
                                                fraction( 3, 3 ) ),
                                          list( fraction( 2, 4 ),
