...
[Setup]
AppVerName=WinHTTrack Website Copier 3.41
...
[Files]
Source: "L:\HTTrack\httrack\html\*.*"; DestDir: "{app}\html"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\templates\*.*"; DestDir: "{app}\templates"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\lang\*.*"; DestDir: "{app}\lang"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\libtest\*.*"; DestDir: "{app}\libtest"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\src\*.*"; DestDir: "{app}\src"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\src_win\*.*"; DestDir: "{app}\src_win"; CopyMode: alwaysoverwrite; Flags: recursesubdirs
Source: "L:\HTTrack\httrack\*.*"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "L:\HTTrack\file_id.diz"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "L:\HTTrackFiles\winhttrack.log"; DestDir: "{app}"; CopyMode: alwaysoverwrite
;Source: "L:\HTTrack\httrack\dll\*.dll"; DestDir: "{sys}"; CopyMode: normal; Flags: uninsneveruninstall sharedfile restartreplace
Source: "L:\HTTrack\httrack\WinHTTrackIEBar.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite; Flags: regserver
...
; .whtt launch
Root: HKCR; Subkey: ".whtt\ShellNew"; Flags: uninsdeletekey noerror
Root: HKCR; Subkey: ".whtt"; Flags: uninsdeletekey noerror
; New menu
Root: HKCR; Subkey: "WinHTTrackProject"; Flags: uninsdeletekey noerror
Root: HKLM; Subkey: "Software\Classes\WinHTTrackProject"; Flags: uninsdeletekey noerror
; Launch and various things to remove
Root: HKCR; Subkey: "Applications\WinHTTrack.exe"; Flags: uninsdeletekey noerror
Root: HKLM; Subkey: "SOFTWARE\Classes\Applications\WinHTTrack.exe"; Flags: uninsdeletekey noerror
; Sound events
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack"; ValueType: string; ValueData: "WinHTTrack Website Copier"; Flags: uninsdeletekey noerror
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: ""; Flags: uninsdeletekey noerror
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: ""; Flags: uninsdeletekey noerror
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror
Root: HKCU; Subkey: "AppEvents\EventLabels\MirrorFinished"; ValueType: string; ValueData: "Mirror Finished"; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack"; ValueType: string; ValueData: "WinHTTrack Website Copier"; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: ""; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: ""; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror
Root: HKU; Subkey: ".DEFAULT\AppEvents\EventLabels\MirrorFinished"; ValueType: string; ValueData: "Mirror Finished"; Flags: uninsdeletekey noerror
