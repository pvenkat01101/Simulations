...
import static edu.colorado.phet.fractions.fractionsintro.FractionsIntroApplication.recordRegressionData;
import static edu.colorado.phet.fractions.fractionsintro.FractionsIntroSimSharing.ModelActions.changed;
import static edu.colorado.phet.fractions.fractionsintro.FractionsIntroSimSharing.ModelComponentTypes.containerSetComponentType;
import static edu.colorado.phet.fractions.fractionsintro.FractionsIntroSimSharing.ModelComponents.containerSetComponent;
import static edu.colorado.phet.fractions.fractionsintro.FractionsIntroSimSharing.ParameterKeys.containerSetKey;
...
public class FractionsIntroModel implements Serializable {
    ...
    @SuppressWarnings("unchecked") private F<IntroState, IntroState> evaluate( final F<IntroState, IntroState> f ) {
        return recordRegressionData ? RegressionTestRecorder.record( f ) : f; //unchecked warning
    }
