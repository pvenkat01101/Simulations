 ...
 * @author iiley
 */
class org.aswing.tree.TreePath implements Identifiable{
	 /** 
    ...
    /**
	 * Returns the idCode of the instance.
     */
	public function getIdCode() : String {
		if(isIdentifiable()){
			return (Identifiable(lastPathComponent)).getIdCode();
		}
		return null;
	}
	
	/**
	 * Returns true if the treepath is identifiable, otherwise false.
	 */
	public function isIdentifiable():Boolean{
		return lastPathComponent instanceof Identifiable;
	}
