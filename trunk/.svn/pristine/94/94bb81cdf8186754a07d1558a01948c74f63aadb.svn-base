...
class Internationalizer{
	...
	function initialize(){
		...
		//trace("voltage text: "+_root.voltageLabel.label_txt.text);
		//trace("label: "+simStrings.get( "voltage" ));
		this.setString(_root.voltageLabel.label_txt, "voltage", "center");
		this.setString(_root.resistanceLabel.label_txt, "resistance", "center");
